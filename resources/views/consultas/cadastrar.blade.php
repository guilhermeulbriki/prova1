@extends('layouts.principal')
  @section('header')
    <h1 class="h1">Adicionar nova Consulta</h1>
  @endsection()
  ...
  @section('conteudo')
    <form action="{{ route('consultas.store') }}" method="POST">
      ...
      <div class="form-group mt-3">
        <label>Data:</label>
        <input value="{{ old('data') }}" class="form-control" type="text" name="data" placeholder="00/00/0000">
      </div>

      <div class="form-group mt-3">
        <label>Hora:</label>
        <input value="{{ old('hora') }}" class="form-control" type="text" name="hora" placeholder="00:00">
      </div>
      ...
      <div class="form-group mt-3">
        <label>Valor:</label>
        <input value="{{ old('valor') }}" class="form-control" type="text" name="valor" placeholder="R$ 0,00">
      </div>
